...
exports.isBelowRN65 =
  ((_b =
    (_a = react_native_1.Platform.constants) === null || _a === void 0
      ? void 0
      : _a.reactNativeVersion) === null || _b === void 0
    ? void 0
    : _b.minor) < 65;
/**
 ...
 */
exports.isRNGH2 = function () {
  // eslint-disable-next-line @typescript-eslint/no-var-requires
  var version = require('react-native-gesture-handler/package.json').version;
